...
$isweekonly = (isset($_SESSION['isweekonly']) && $_SESSION['isweekonly']>0);


$weeksin = req('weeks','n');
$isweekonly = ($isweekonly===true || $weeksin>0);

$timeperiod = ($isweekonly==true) ? 'Week' : 'Month' ;

$utype = $_SESSION['user']['type'];

// $isVendor = ($utype !== 'admin' && $utype !== 'operator');
$contenteditable = (ISVENDOR) ? '' : 'contenteditable="true"' ;
$contenteditableattr = $contenteditableattr ?? '';
$contenteditableattr .= (ISVENDOR) ? ' data-bs-toggle="tooltip" title="Click to copy value to clipboard"' : ' data-bs-toggle="tooltip" title="Click to edit directly"' ;
...
if(($initday>24 && $initmonth!='02') || ($initday>23 && $initmonth=='02')){
    if($initmonth>11) {
        $initmonth = '01';
        $inityear++;
    }
...
$titletext = $timeperiod . 'ly <span class="d-none d-sm-inline">Delivery & Returns:</span><span class="d-inline d-sm-none">Data:</span>';
...
$errweekreport = ($isweekonly==false) ? '' : '&weeks=1';

$tt = ($isweekonly==false) ? $USR->getVendorMonths($vid) : $USR->getVendorWeeks($vid);

$tt = ($tt!==false) ? array_reverse($tt) : false;

    $s = '<select name="choosemonth" id="choosemonth" onchange="location.href=\'index.php?loc=report-monthly' . $errweekreport . '&id=' . $vid . '&vid=' . $vid . '&rweekstart=\' + $(this).val() ">';
...
if($tt!=false) {
    ...
    $s .= '<option value="" ' . $initsel . '> Select Month...</option>';
    foreach ($tt as $t) {
...
function switchVendorMenu(){
    global $errweekreport;
    global $passedweek;
    global $USR;
    global $vid;
    global $utype;
    ...
    $sel = '<select class="form-select" name="vendormen" id="vendormen" onchange="location.href=\'index.php?loc=report-totals&id=\' + $(this).val() + \'&vid=\' + $(this).val() + \'&rweekstart=' . $passedweek . '\'; ">';
...
/*
$foots = '<div class="repfootnotes">


                        <p>

                            <strong>*Independent Inventory Replacement </strong> = <em>deliveries and returns tracked on a per-site basis.</em><br>
                            <strong>*Distributed Inventory Replacement</strong> = <em>deliveries are only calculated to the <strong>primary site</strong>. <span class="secondline">All deliveries to secondary sites are omitted from calculation totals (numbers are left in the daily display columns for Vendor\'s internal tracking purposes)</span> </em>
                        </p>
...
$primarymess = ($isPrimaryMode) ? '*Distributed Inventory Replacement.' : '*Independent Inventory Replacement.';
...
<div class="row g-3">
    ...
    $chooselink = ($utype === 'vendor') ? '' : 'index.php?loc=report-entry&t=reports&ng=reports&dest=' . strtolower($timeperiod) . 'ly';
    $adminlinks = ($utype === 'vendor') ? '' : '<span class="d-none d-sm-inline"><strong class="breadslash">\</strong> <a class="breadcrumblink" href="' . $chooselink . '">Vendors</a></span>';
    ?>

    <!-- BREADCRUMB DOM HOLDER (INVIS) -->
    <div style="text-align:right;" class="position-relative pt-3 pe-3 col-auto d-block me-2 breadcrumbholdr blockr">
<!--
    ...
    <!-- BREADCRUMB background white to SUPPORT NORMAL GRADATION OVER SCROLLABLE CONTENT -->
    <div style="text-align:right;" class="position-relative pt-3 pe-3 col-auto d-block me-2 breadcrumbholdr backgroundr">
<!--
        <div class="col-auto fs--1 text-600 edit profilelooplink atcontrol editprofilelink position-absolute bottompix-5 start-35 ms-3 ms-sm-3 ps-0"><span class="mb-0 undefined"></span>
            <a class="backlink text-primary" href="<?php echo $returnlink; ?>"><i class="far fa-arrow-alt-circle-left"></i> <span class="d-sm-inline-block">Back </span> <span class="d-sm-inline-block linklabel"></span></a></div>
        <h6 class="text-uppercase text-600 breadcrumbs">
    ...
    <div style="text-align:right;" class="position-relative pt-3 pe-3 col-auto d-block me-2 breadcrumbholdr">
        ...
        <div class="col-auto fs--1 text-600 edit profilelooplink atcontrol editprofilelink position-absolute bottompix-5 start-35 ms-3 ms-sm-3 ps-0"><span class="mb-0 undefined"></span>
            <a class="backlink text-primary" href="<?php echo $returnlink; ?>"><i class="far fa-arrow-alt-circle-left"></i> <span class="d-sm-inline-block">Back </span> <span class="d-sm-inline-block linklabel"></span></a></div>
        <h6 class="text-uppercase text-600 breadcrumbs">
            <a class="breadcrumblink" href="<?php echo $homelink; ?>"><?php echo $utype; ?></a> <?php echo $adminlinks; ?>  <strong class="breadslash">\</strong> <span class="d-none d-sm-inline"><?php echo $ven['company_name'] ?> <strong class="breadslash">:</strong> </span><?php echo $timeperiod; ?>ly</h6>
    </div>
...
$initshow = ($isweekonly==false) ? 'rmtots' : 'rmweeks';
...
?>
    ...
    <div id="res" class="col-xxl-10 col-xl-9 flex-fill <?php echo $initshow; ?>">
        ...
        <form class="row g-3 needs-validation" id="choose<?php echo $chooser; ?>">
            ...
            <div class="row flex-between-center mb-0">
                <div class="col-auto">
                    <h5 class="reporttitle mb-2 sm-mb-1"><?php echo $titletext; ?> <br class="d-none d-sm-none"><?php echo ($utype === 'admin' || $utype === 'operator') ? switchVendorMenu() : $ven['company_name']; ?></h5>
                    <h5 class="sitesubhead"><?php echo $timeperiod; ?> Beginning: <span class="subheaddate"><?php echo $datedisplay; ?></span></h5>

                    <?php
                    $radiogrpclass = ($passedweek!='') ? 'hidr' : 'hidr';


                    $radiogrpclass .= ($isweekonly==true) ? ' hidr' : 'hidr';
                    ?>
                ...
                <div class="col-auto fs-0 text-600 position-relative">
                        ...
                        $radiovertclass = ($isweekonly==true) ? ' hidr' : '';

                        ?>

                    <div class="viewgroup d-none d-md-block <?php echo $radiovertclass; ?>" data-bs-toggle="">
            ...
            if($isVendorDataExists===true && $bIsInit===false){
                ...
                $bShow = true;
                $thearr = ($isweekonly==true) ? array(0) : array(0,7,14,21,28,35); //5 weeks of potential data
                $startnumr = 0;
                $hasinit = false;
                $UWeekArr = array();
                $currentweek = '';
                                ...
                                if(isset($sites[0])){
                                   ...
                                   //     $dates[$notesdc] = array();
                                        ...
                                        foreach($invArr as $inv) {
                                         ...
                                         //       $dates[$notesdc][$inv] = $USR->fDate(${$day}, 'Y-m-d');
                                        ...
                                        if(is_array($activeArr) && count($activeArr)>0){
                                            foreach($activeArr as $k=>$v){
                                                ...
                                                $siteid = $id;
                                                $vendorid = $vid;
                                                $allotname = "$abbrname" . "allott";
                                                $totsname = "$abbrname" . "tots";
                                                $origname = "$abbrname" . "orig";
                                                $primename = "$abbrname" . "prime";
                                                $amtname = "$abbrname" . "_amt";

                                              //  $formidval = "is_$abbrname" . "deliverform";

                                                $subattr = 'data-sub-invname="' . $abbrname . '" data-sub-siteid="' .  $siteid . '" data-sub-vendorid="' .  $vendorid . '" data-sub-' . $isname . '="1" ';
												...
												$showprimaryflag = ($is_primary>0) ? ' isprimarysite' : ' notprimarysite';
                                                ...
                                                <tr class="siteinvresultrow <?php echo $sclass; ?> position-relative SITE<?php echo $id . strtoupper($notesdc); ?>  <?php echo $showprimaryflag; ?> " <?php echo $attr; ?>  <?php echo $subattr; ?> data-product="<?php echo $disptype; ?>" id="SITE<?php echo $id . strtoupper($notesdc); ?>">
                                                    ...
                                                    <td width="" scope="col" data-secondcol='Type' data-bs-toggle="tooltip" title="Click to show only <?php echo $disptype; ?>" class="text-bold secondlev typecol"><?php echo $disptype; ?></td>
                                                    ...
                                                    foreach($v as $key=>$val){
                                                        ...
                                                        $substr = '';
                                                        $formiddelval = "is_$abbrname" . "deliverform";
                                                        $formidretval = "is_$abbrname" . "receivingform";


                                                        $itementryattr = ' data-sub-entrydate="' .  $USR->fDate(${$key}, 'Y-m-d') . '" ';

                                                        $actionformiddel = ' data-sub-formid="' . $formiddelval . '"  ';
                                                        $actionformidret = ' data-sub-formid="' . $formidretval . '"  ';



                                                        /*
                                                         * form submission for is_3_comp_clamshellsdeliverform
                                                                is_3_comp_clamshells = 1
                                                                siteid = 17
                                                                vendorid = 11
                                                                3_comp_clamshellsallott = 0
                                                                3_comp_clamshellstots = 70
                                                                3_comp_clamshellsorig = 50
                                                                3_comp_clamshellsprime = 0
                                                                entrydate = 2024-11-23
                                                                3_comp_clamshells_amt = 20
                                                         */


												//			data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" data-sub-formid="" ;




                                                        $primaryModeReturnsDisplayAttr = ($is_primary>0 && $isPrimaryMode) ? ' data-override-totals="0" ' : '';
                                                        $primaryModeReturnsDisplayTriggerClass = ($is_primary>0 && $isPrimaryMode) ? ' returndisplayoverride ' : '';

                                                                //delivered old - title="' . $deltttitle . '" data-bs-toggle="' . $delactivett . '"
                                                        //returrned old title = data-bs-toggle="' . $retactivett . '"  title="' . $rettttitle . '"


                                                        echo '
                                                        <td width="" scope="col" data-bs-html="true" ' . $contenteditableattr . ' ' . $contenteditable . '  ' . $itementryattr . $actionformiddel . ' class="pair1 ' . $delcursornull . ' ' . $key . ' distributed">' . $v[$key]["delivered"] . '</td>
                                                        <td width="" scope="col" data-bs-html="true" ' . $contenteditableattr . ' ' . $contenteditable . '  ' . $itementryattr . $actionformidret . ' class="returned ' . $retcursornull . ' ' . $key . ' ' . $primaryModeReturnsDisplayTriggerClass . ' pair2" ' . $primaryModeReturnsDisplayAttr . '>' . $v[$key]["returned"] . '</td>
                                                        <td width="" scope="col" data-bs-toggle="' . $retactivett . '"  data-bs-html="true" title="' . $rettttitle . '" class="damaged ' . $retcursornull . ' ' . $key . ' pair2">' . $v[$key]["damaged"] . '</td>
                                                        ';
                ...
                ?>
                    ...
                    <table class="table chooser reporttable totalstable invis">
                        ...
                        foreach($gTot as $key=>$val){
                            echo '<!-- KEY: ' . print_r($key,true) . '  VAL: ' . print_r($val,true) . ' date: ' . $initmonthdate . '-->';
                            $sfindel = 0;
                            $sfinret = 0;
                            $sfindam = 0;
                            $sfintot = 0;
                            ...
                            $unid = "9999$totincr";
                                    ...
                                    //damage override table
                                    $typeDamTots = $USR->getDamagedTypeTotals($stype,$vid,$initmonthdate,$nextmonthdate);
                                    ...
                                    //check override damage tables
                                    $thisdamaged = (isset($typeDamTots[0]) && $typeDamTots[0]['TOTAL_DAMAGED']>0) ? $typeDamTots[0]['TOTAL_DAMAGED'] : $thisdamaged;
                                    ...
                                    $damattr = (ISVENDOR) ? 'onclick="copyInst(\".sitetotalreturned$unid\",\"td\")' : ' contenteditable="true"';
                                    $damtitle = (ISVENDOR) ? ' data-bs-toggle="tooltip" title="Click to copy value to clipboard"' : 'data-bs-toggle="tooltip" title="Click to edit directly"';
                                    ...
                                    $damattr .= $damtitle;
                                        ...
                                        $formiddamval = "is_$abbrname" . "receivingform";


                                        $itementryattr = ' data-sub-entrydate="' .  $USR->fDate($initmonthdate, 'Y-m-d') . '" ';


                                        $actionformiddam = ' data-sub-formid="' . $formiddamval . '"  ';

										$damattr .= " $itementryattr $actionformiddam "
                        ...
                        <tr class="siteinvresultrow    position-relative SITE<?php echo $unid . $sitecode; ?>" <?php echo $subattr; ?> data-sitename="<?php echo $sitecode; ?>" data-product="<?php echo $disptype; ?>" id="SITE<?php echo $unid; ?><?php echo $sitecode; ?>">
                        ...
                        <!--    <td width="" scope="col" data-secondcol="Site" data-bs-toggle="tooltip" data-bs-html="true" class="site text-bold secondlev nobords position-relative" title="<?php echo $sname; ?>"><?php echo $sname; ?><div class="site text-bold secondlev visibility-hidden"></div></td> -->
                            ...
                            <td width="" scope="col" data-secondcol='Type' data-bs-toggle="tooltip" title="Click to show only <?php echo $disptype; ?>" data-dispname="<?php echo $disptype; ?>"  class="text-bold secondlev typecol"><?php echo $disptype; ?></td>
                            ...
                            <td width="" scope="col"  class="balance damaged  nullpointer monday pair2 text-bold sitetotaldamaged<?php echo $unid; ?>" <?php echo $damattr; ?>><?php echo $thisdamaged; ?><span id="" class="visibility-hidden sitetotaldamaged<?php echo $unid; ?>unfocus" > </span></td>
