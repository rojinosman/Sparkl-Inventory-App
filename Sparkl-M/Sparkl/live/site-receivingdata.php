...
<?php
    ...
    $enfrc_allowedtypes = array('operator','admin');
...
if($uid>0){
    ...
    $prevdata = $USR->getPrevSiteData($siteid,$vendorid,'all',true,$entrydate);
    ...
    if(isset($prevdata[0])) {
        ...
        foreach ($prevdata as $d) {
            ...
            $values[$type . '_dmg'] = $d['inventory_dmg'];
    ...
    <div class="row g-3">
        ...
        <div style="text-align:right;" class="position-relative pt-3 pe-3 col-auto d-block me-2 breadcrumbholdr">
            ...
            <h6 class="text-uppercase text-600 breadcrumbs">
                Returns <strong class="breadslash">\</strong> <span class="d-none d-sm-inline"><a class="breadcrumblink" href="javascript:history.back();"><?php echo $pre; ?></a> <strong class="breadslash">\</strong></span> <span class="d-none d-sm-inline"><?php echo $titletext; ?> <strong class="breadslash">\</strong> </span> Enter Data</h6>
        </div>
        ...
        <!--    <form class="row g-3 needs-validation" id="<?php echo $dynforms['receivingdata']['formname']; ?>"> -->

                <div class="row flex-between-center mb-0">
                    <div class="col-auto">
                        <h5 class="vensitetitle"><?php echo "$venicon$pre<span class='d-none d-sm-inline-block'>:</span> $mobilebreak <span class=\"subtitle\"> $siteicon $titletext > Returns</span>"; ?></h5>
                    </div>
            ...
            echo writeFields('receivingdata',$values);
                ...
                $notedata = $USR->getPrevNoteData($siteid,$vendorid,true,$dispdate);
                ...
                <form id="finalizereceiving">

                    <div class="row gs3 w-md-100 ms-0">

                        <div class=" col-md-9 buttonholdr form-floating jsonform-">
                    ...
                    <div class="col-md-9 form-floating jsonform- textareaholdr notesholdr <?php echo $completeclass; ?>">
                    ...
                    <div class="col-md-12 mt-4 mb-4 form-floating jsonform- hidr showsuccessholdr">
                    ...
                    <div class="row gs3 w-md-100 ms-0">
                        ...
                        <!-- submit -->
                        <div class=" col-md-9 buttonholdr form-floating jsonform-">
                            <button class="btn btn-primary w-100 finalizedata" id="receiving" type="button" ><span class="buttontext"><?php echo $buttontext; ?></span>
                                <span class="spinner-border spinner-border-sm hidr" role="status" aria-hidden="true"></span>
