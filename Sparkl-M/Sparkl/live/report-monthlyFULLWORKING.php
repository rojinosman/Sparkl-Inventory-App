            ...
            <form class="row g-3 needs-validation" id="choose<?php echo $chooser; ?>">
                ...
                if($isVendorDataExists===true && $bIsInit===false){
                            ...
                            <table class="table chooser reporttable ">
                                ...
                                <tr class="primaryhead">
                                   ...
                                   <!-- <th width="" scope="col" data-secondcol='Site' class="secondlev"> </th> -->
                                    ...
                                    <th class="daterowhead <?php echo $showlabel; ?>" scope="col" colspan="3"> <?php echo "Monday " . substr($monday,0,5); ?> </th>
                                    <?php $showlabel = ($USR->fDate($tuesday,'Y-m-d') < $initmonthdate || $USR->fDate($tuesday,'Y-m-d') >= $nextmonthdate) ? '' : ''; ?>
                                    <th class="daterowhead <?php echo $showlabel; ?>" scope="col" colspan="3"> <?php echo "Tuesday " . substr($tuesday,0,5); ?> </th>
                                    <?php $showlabel = ($USR->fDate($wednesday,'Y-m-d') < $initmonthdate || $USR->fDate($wednesday,'Y-m-d') >= $nextmonthdate) ? '' : ''; ?>
                                    <th class="daterowhead <?php echo $showlabel; ?>" scope="col" colspan="3"> <?php echo "Wednesday " . substr($wednesday,0,5); ?> </th>
                                    <?php $showlabel = ($USR->fDate($thursday,'Y-m-d') < $initmonthdate || $USR->fDate($thursday,'Y-m-d') >= $nextmonthdate) ? '' : ''; ?>
                                    <th class="daterowhead <?php echo $showlabel; ?>" scope="col" colspan="3"> <?php echo "Thursday " . substr($thursday,0,5); ?> </th>
                                    <?php $showlabel = ($USR->fDate($friday,'Y-m-d') < $initmonthdate || $USR->fDate($friday,'Y-m-d') >= $nextmonthdate) ? '' : ''; ?>
                                    <th class="daterowhead <?php echo $showlabel; ?>" scope="col" colspan="3"> <?php echo "Friday " . substr($friday,0,5); ?> </th>
                                    ...
                                    if(isset($sites[0])){
                                        ...
                                        foreach($sites as $u){
                                            ...
                                            if(is_array($activeArr) && count($activeArr)>0){
                                                foreach($activeArr as $k=>$v){
                                                    ...
                                                    <tr class="siteinvresultrow <?php echo $sclass; ?> position-relative SITE<?php echo $id . strtoupper($notesdc); ?>" <?php echo $attr; ?> id="SITE<?php echo $id . strtoupper($notesdc); ?>">
                                                        ...
                                                        foreach($v as $key=>$val){
                                                            ...
                                                            echo '
                                                            <td width="" scope="col" data-bs-toggle="' . $delactivett . '" data-bs-html="true" title="' . $deltttitle . '" class="pair1 ' . $delcursornull . ' ' . $key . ' distributed">' . $v[$key]["delivered"] . '</td>
                                                            <td width="" scope="col" data-bs-toggle="' . $retactivett . '" data-bs-html="true" title="' . $rettttitle . '" class="returned ' . $retcursornull . ' ' . $key . ' pair2">' . $v[$key]["returned"] . '</td>
                                                ...
                                                ?>
                                                   <tr class="totalsrow">
                                                       <td colspan="17"> </td><td class="balance <?php echo " runningdeltot-$runningdeltot runningrettot-$runningrettot runningdamtot-$runningdamtot "; ?> sitetotal <?php echo $cursornull; ?> sitetotal<?php echo $id; ?>" data-bs-toggle="<?php echo $activett; ?>" title="<?php echo $tttitle; ?>" id="" onclick="copyInst('.sitetotal<?php echo $id; ?>','td')"><?php echo $runningtot; ?><span id="" class="visibility-hidden sitetotal<?php echo $id; ?>unfocus"> </span></td>
                                                   </tr>
                    ...
                    ?>
                        ...
                        <table class="table chooser reporttable totalstable">
                            <!-- test2 -->
                            <thead>
                            ...
                            <tr class="siteinvresultrow    position-relative SITE<?php echo $unid . $sitecode; ?>" data-sitename="<?php echo $sitecode; ?>" id="SITE<?php echo $unid; ?><?php echo $sitecode; ?>">
                            ...
                            <!--    <td width="" scope="col" data-secondcol="Site" data-bs-toggle="tooltip" data-bs-html="true" class="site text-bold secondlev nobords position-relative" title="<?php echo $sname; ?>"><?php echo $sname; ?><div class="site text-bold secondlev visibility-hidden"></div></td> -->
                                ...
                                <td width="" scope="col" data-bs-toggle="tooltip" title="Click to copy value to clipboard." class="balance damaged  nullpointer monday pair2 text-bold sitetotaldamaged<?php echo $unid; ?>" onclick="copyInst('.sitetotaldamaged<?php echo $unid; ?>','td')"><?php echo $thisdamaged; ?><span id="" class="visibility-hidden sitetotaldamaged<?php echo $unid; ?>unfocus"> </span></td>



                                <td width="" scope="col" data-bs-toggle="tooltip" title="Click to copy value to clipboard." class="balance   nullpointer text-bold sitetotalbalance<?php echo $unid; ?>" onclick="copyInst('.sitetotalbalance<?php echo $unid; ?>','td')"><?php echo $thisbalance; ?><span id="" class="visibility-hidden sitetotalbalance<?php echo $unid; ?>unfocus"> </span></td>
                            </tr>
                            ...
                            <tr class="totalsrow siteinvresultrow  firstrow  position-relative SITE999888" data-sitename="" id="SITE999888Totals">
                              ...
                              <!--  <td colspan=""> </td> -->
                                ...
                                <td class="balance sitetotal sitetotal9999 nullpointer" data-bs-toggle="tooltip" title="Click to copy value to clipboard." id="" onclick="copyInst('.sitetotal9999','td')"><?php echo $dTotsArr['delivered']; ?><span id="" class="visibility-hidden sitetotal9999unfocus"> </span></td>
                                <td class="balance sitetotal sitetotal9998 nullpointer" data-bs-toggle="tooltip" title="Click to copy value to clipboard." id="" onclick="copyInst('.sitetotal9998','td')"><?php echo $dTotsArr['returned']; ?><span id="" class="visibility-hidden sitetotal9998unfocus"> </span></td>
                                <td class="balance sitetotal sitetotal9997 nullpointer" data-bs-toggle="tooltip" title="Click to copy value to clipboard." id="" onclick="copyInst('.sitetotal9997','td')"><?php echo $dTotsArr['damaged']; ?><span id="" class="visibility-hidden sitetotal9997unfocus"> </span></td>
                                <td class="balance sitetotal sitetotal9996 nullpointer" data-bs-toggle="tooltip" title="Click to copy value to clipboard." id="" onclick="copyInst('.sitetotal9996','td')"><?php echo $dTotsArr['balance']; ?><span id="" class="visibility-hidden sitetotal9996unfocus"> </span></td>
